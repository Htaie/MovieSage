...
export const UsersFilmsList = ({ formType }: { formType: string }) => {
  ...
  return (
    <>
      {formType === PROFILE_ROUTE.RATED && (
        <div
          onClick={openSearchModal}
          className='flex justify-center items-center text-white bg-[#5138E9] h-[30px] w-[300px] hover:cursor-pointer rounded-lg ml-[195px] mt-2'
        >

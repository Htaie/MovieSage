...
const Login = () => {
  ...
  return (
    <div>
      ...
      <Modal isOpen={modalIsOpen} onRequestClose={closeModal} style={customStyles} contentLabel="Login">
        <div className="text-white">
          ...
          <button className="w-full h-12 text-gray-800 bg-white rounded-lg mb-2" onClick={closeModal}>
            Login
          </button>
          <div className="flex justify-center">
